...
import (
	...
	http "net/http"
	v1 "nopresh.apetrovic.com/gen/proto/auth/v1"
	strings "strings"
)
...
const (
	...
	AuthServiceLogoutProcedure = "/proto.auth.v1.AuthService/Logout"
	// AuthServiceMeProcedure is the fully-qualified name of the AuthService's Me RPC.
	AuthServiceMeProcedure = "/proto.auth.v1.AuthService/Me"
)
...
type AuthServiceClient interface {
	...
	// buf:lint:ignore RPC_REQUEST_STANDARD_NAME
	// buf:lint:ignore RPC_REQUEST_RESPONSE_UNIQUE
	Me(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.MeResponse], error)
}
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	return &authServiceClient{
		...
		me: connect.NewClient[emptypb.Empty, v1.MeResponse](
			httpClient,
...
type authServiceClient struct {
	...
	me       *connect.Client[emptypb.Empty, v1.MeResponse]
}
...
// Logout calls proto.auth.v1.AuthService.Logout.
...
// Me calls proto.auth.v1.AuthService.Me.
func (c *authServiceClient) Me(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.Response[v1.MeResponse], error) {
...
func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.auth.v1.AuthService.Logout is not implemented"))
}

func (UnimplementedAuthServiceHandler) Me(context.Context, *connect.Request[emptypb.Empty]) (*connect.Response[v1.MeResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.auth.v1.AuthService.Me is not implemented"))
}

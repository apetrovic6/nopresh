...
import (
	...
	errors "errors"
	http "net/http"
	v1 "nopresh.apetrovic.com/gen/proto/settings/v1"
	strings "strings"
)
...
const (
	...
	SettingsServiceName = "proto.settings.v1.SettingsService"
)
...
const (
	...
	// CreateSettings RPC.
	SettingsServiceCreateSettingsProcedure = "/proto.settings.v1.SettingsService/CreateSettings"
	// SettingsServiceGetSettingsProcedure is the fully-qualified name of the SettingsService's
	// GetSettings RPC.
	SettingsServiceGetSettingsProcedure = "/proto.settings.v1.SettingsService/GetSettings"
	// SettingsServiceUpdateSettingsProcedure is the fully-qualified name of the SettingsService's
	// UpdateSettings RPC.
	SettingsServiceUpdateSettingsProcedure = "/proto.settings.v1.SettingsService/UpdateSettings"
)

// SettingsServiceClient is a client for the proto.settings.v1.SettingsService service.
type SettingsServiceClient interface {
	CreateSettings(context.Context, *connect.Request[v1.CreateSettingsRequest]) (*connect.Response[v1.CreateSettingsResponse], error)
...
// NewSettingsServiceClient constructs a client for the proto.settings.v1.SettingsService service.
...
func NewSettingsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SettingsServiceClient {
	...
	settingsServiceMethods := v1.File_proto_settings_v1_settings_proto.Services().ByName("SettingsService").Methods()
	return &settingsServiceClient{
		createSettings: connect.NewClient[v1.CreateSettingsRequest, v1.CreateSettingsResponse](
			httpClient,
			baseURL+SettingsServiceCreateSettingsProcedure,
			connect.WithSchema(settingsServiceMethods.ByName("CreateSettings")),
...
type settingsServiceClient struct {
	createSettings *connect.Client[v1.CreateSettingsRequest, v1.CreateSettingsResponse]
	getSettings    *connect.Client[v1.GetSettingsRequest, v1.GetSettingsResponse]
	updateSettings *connect.Client[v1.UpdateSettingsRequest, v1.UpdateSettingsResponse]
}

// CreateSettings calls proto.settings.v1.SettingsService.CreateSettings.
func (c *settingsServiceClient) CreateSettings(ctx context.Context, req *connect.Request[v1.CreateSettingsRequest]) (*connect.Response[v1.CreateSettingsResponse], error) {
	return c.createSettings.CallUnary(ctx, req)
}

// GetSettings calls proto.settings.v1.SettingsService.GetSettings.
...
// UpdateSettings calls proto.settings.v1.SettingsService.UpdateSettings.
...
// SettingsServiceHandler is an implementation of the proto.settings.v1.SettingsService service.
...
func NewSettingsServiceHandler(svc SettingsServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/proto.settings.v1.SettingsService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSettingsServiceHandler) CreateSettings(context.Context, *connect.Request[v1.CreateSettingsRequest]) (*connect.Response[v1.CreateSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.settings.v1.SettingsService.CreateSettings is not implemented"))
}
...
func (UnimplementedSettingsServiceHandler) GetSettings(context.Context, *connect.Request[v1.GetSettingsRequest]) (*connect.Response[v1.GetSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.settings.v1.SettingsService.GetSettings is not implemented"))
}
...
func (UnimplementedSettingsServiceHandler) UpdateSettings(context.Context, *connect.Request[v1.UpdateSettingsRequest]) (*connect.Response[v1.UpdateSettingsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("proto.settings.v1.SettingsService.UpdateSettings is not implemented"))
}
